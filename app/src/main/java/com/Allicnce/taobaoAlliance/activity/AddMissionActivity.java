...
public class AddMissionActivity extends BaseActivity {
    ...
    @Bind(R.id.rv_missionitem)
    RecyclerView rv_missionitem;
    ...
    public int getLayoutId() {
        ...
        return R.layout.fragment_addmission;
    }
    ...
    public void initView() {
        ...
        baseQuickAdapter = new BaseQuickAdapter<ImageItem, BaseViewHolder>(R.layout.item_choosepic, images) {
            ...
            protected void convert(BaseViewHolder helper, ImageItem item) {
                ...
                if (helper.getLayoutPosition() < images.size() - 1 || helper.getLayoutPosition() == 6) {
                    GlideImageLoader.displayImage(AddMissionActivity.this, images.get(helper.getLayoutPosition()).path, imageView);
                }
            }

        };
        rv_missionitem.setLayoutManager(new LinearLayoutManager(this));
        rv_missionitem.setAdapter(new BaseQuickAdapter<ImageItem, BaseViewHolder>(R.layout.item_mission, images) {
        ...
        baseQuickAdapter.setOnItemChildClickListener((adapter, view, position) -> {
            if (position == images.size() - 1 && position != 6) {
                ...
                Intent intent = new Intent(AddMissionActivity.this, ImageGridActivity.class);
