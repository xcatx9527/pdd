 ...
 * @Description
 */
public class ImagePickerDemoActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener, CompoundButton.OnCheckedChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagePicker.setImageLoader(GlideImageLoader.instance);
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                imageView = new ImageView(ImagePickerDemoActivity.this);
            ...
            imagePicker.getImageLoader().displayImage(ImagePickerDemoActivity.this, getItem(position).path, imageView, size, size);
            return imageView;
        }
    }
}
