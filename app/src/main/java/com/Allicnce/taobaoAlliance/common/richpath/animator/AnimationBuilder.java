package com.Allicnce.taobaoAlliance.common.richpath.animator;
...
import com.Allicnce.taobaoAlliance.common.richpath.pathparser.PathDataNode;
import com.Allicnce.taobaoAlliance.common.richpath.pathparser.PathParserCompat;
...
public class AnimationBuilder {
    ...
    private int repeatMode = RichPathAnimator.RESTART;
    ...
    public AnimationBuilder pathData(String... pathData) {
        ...
        for (final RichPath path : paths) {
            ObjectAnimator objectAnimator = ObjectAnimator.ofObject(path, "pathDataNodes", new PathEvaluator(), (Object) pathDataNodes);
            applyAnimatorProperties(objectAnimator, path);
        }
        return this;
    }
