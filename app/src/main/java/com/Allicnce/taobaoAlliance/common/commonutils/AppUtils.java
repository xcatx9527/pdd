...
public final class AppUtils {
     ...
     */
    public static boolean isInstallApp(String filePath) {
        return !isSpace(getPackageName(filePath)) && IntentUtils.getLaunchAppIntent(getPackageName(filePath)) != null;
    }
     ...
     * @return {@code true}: 已安装<br>{@code false}: 未安装
     */
    public static boolean isInstallAppForPackage(String PackageName) {
    ...
    public static void launchApp(String packageName) {
        if (isSpace(packageName)) return;
        BaseApplication.instance.startActivity(IntentUtils.getLaunchAppIntent(packageName));
    }
    ...
    public static void getAppDetailsSettings(Activity activity) {
        getAppDetailsSettings(activity, BaseApplication.instance.getPackageName());
    }
    ...
    public static String getAppName() {
        return getAppName(BaseApplication.instance.getPackageName());
    }
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(BaseApplication.instance.getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(BaseApplication.instance.getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(BaseApplication.instance.getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(BaseApplication.instance.getPackageName());
    }
    ...
    public static boolean isSystemApp() {
        return isSystemApp(BaseApplication.instance.getPackageName());
    }
    ...
    public static boolean isAppDebug() {
        return isAppDebug(BaseApplication.instance.getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(BaseApplication.instance.getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(BaseApplication.instance.getPackageName());
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(BaseApplication.instance.getPackageName());
    }

    public static String getSignatures() {
        return getSignatures(BaseApplication.instance.getPackageName());
    }
   ...
   /* private Signature[] getRawSignature(Context paramContext, String paramString) {
    ...
    private void getSign(String paramString) {
        paramString = getRawSignature(this, paramString);
        if ((paramString == null) || (paramString.length == 0)) {
        }
        for (; ; ) {
            return;
    ...
    public static String getSignatures(String packageName) {
        try {
            String pubKey = null;
            String signNumber = null;
            PackageManager pm = BaseApplication.instance.getPackageManager();
            PackageInfo pi = pm.getPackageInfo(packageName, PackageManager.GET_SIGNATURES);
            try {
                CertificateFactory certFactory = CertificateFactory.getInstance("X.509");
                X509Certificate cert = (X509Certificate) certFactory.generateCertificate(new ByteArrayInputStream(pi.signatures[0].toByteArray()));
            ...
            return EncryptUtils.md5Encrypt(pubKey);
        } catch (PackageManager.NameNotFoundException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static String getUmMetaData() {
        ...
        try {
            appInfo = BaseApplication.instance.getPackageManager().getApplicationInfo(BaseApplication.instance.getPackageName(), PackageManager.GET_META_DATA);
        } catch (PackageManager.NameNotFoundException e) {
            e.printStackTrace();
        }
