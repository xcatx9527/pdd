...
public final class PhoneUtils {
    ...
    public static boolean isPhone() {
        TelephonyManager tm = (TelephonyManager) BaseApplication.instance.getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String getPhoneStatus() {
        TelephonyManager tm = (TelephonyManager) BaseApplication.instance
    ...
    public static void dial(String phoneNumber) {
        BaseApplication.instance.startActivity(IntentUtils.getDialIntent(phoneNumber));
    }
    ...
    public static void call(String phoneNumber) {
        BaseApplication.instance.startActivity(IntentUtils.getCallIntent(phoneNumber));
    }
    ...
    public static void sendSms(String phoneNumber, String content) {
        BaseApplication.instance.startActivity(IntentUtils.getSendSmsIntent(phoneNumber, content));
    }
    ...
    public static void sendSmsSilent(String phoneNumber, String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(BaseApplication.instance, 0, new Intent(), 0);
    ...
    public static List<HashMap<String, String>> getAllContactInfo() {
        ...
        // 1.获取内容解析者
        ContentResolver resolver = BaseApplication.instance.getContentResolver();
    ...
    public static void getContactNum() {
        ...
        /*
        Intent intent = newdialog Intent();
