...
public final class SpannableStringUtils {
    ...
    public static class Builder {
        ...
        public Builder setForegroundColor(@ColorRes int color) {
            this.foregroundColor = BaseApplication.instance.getResources().getColor(color);
            return this;
        }
        ...
        public Builder setBackgroundColor(@ColorRes int color) {
            this.backgroundColor = BaseApplication.instance.getResources().getColor(color);
            return this;
        }
         ...
         * @return {@link Builder}
         */
        public Builder append(@NonNull CharSequence text, int forceColor) {
            setSpan();
            this.text = text;
            setForegroundColor(forceColor);
            return this;
        }
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new CustomImageSpan(BaseApplication.instance, bitmap, align), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    mBuilder.setSpan(new CustomImageSpan(BaseApplication.instance, uri, align), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    mBuilder.setSpan(new CustomImageSpan(BaseApplication.instance, resourceId, align), start, end, flag);
                    resourceId = 0;
