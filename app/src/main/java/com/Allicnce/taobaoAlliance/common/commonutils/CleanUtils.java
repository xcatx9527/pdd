...
public final class CleanUtils {
    ...
    public static boolean cleanInternalCache() {
        return FileUtils.deleteFilesInDir(BaseApplication.instance.getCacheDir());
    }
    ...
    public static boolean cleanInternalFiles() {
        return FileUtils.deleteFilesInDir(BaseApplication.instance.getFilesDir());
    }
    ...
    public static boolean cleanInternalDbs() {
        return FileUtils.deleteFilesInDir(BaseApplication.instance.getFilesDir().getParent() + File.separator + "databases");
    }
    ...
    public static boolean cleanInternalSP() {
        return FileUtils.deleteFilesInDir(BaseApplication.instance.getFilesDir().getParent() + File.separator + "shared_prefs");
    }
    ...
    public static boolean cleanExternalCache() {
        return SDCardUtils.isSDCardEnable() && FileUtils.deleteFilesInDir(BaseApplication.instance.getExternalCacheDir());
    }
