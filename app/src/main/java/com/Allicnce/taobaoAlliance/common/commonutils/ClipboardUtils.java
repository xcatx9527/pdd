...
public final class ClipboardUtils {
    ...
    public static CharSequence getText() {
        ...
        if (clip != null && clip.getItemCount() > 0) {
            return clip.getItemAt(0).coerceToText(BaseApplication.instance);
        }
        return null;
    }
    ...
    public static void copyUri(Uri uri) {
        ClipboardManager clipboard = (ClipboardManager) BaseApplication.instance.getSystemService(Context.CLIPBOARD_SERVICE);
        clipboard.setPrimaryClip(ClipData.newUri(BaseApplication.instance.getContentResolver(), "uri", uri));
    }
