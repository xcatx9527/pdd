...
package com.Allicnce.taobaoAlliance.common.loading.ios;
...
class BarView extends View implements Determinate {
    ...
    private void init() {
        ...
        mOuterPaint.setStrokeWidth(DisplayUtil.dp2px(2));
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        int padding = DisplayUtil.dp2px(2);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int widthDimension = DisplayUtil.dp2px(100);
        int heightDimension = DisplayUtil.dp2px(20);
