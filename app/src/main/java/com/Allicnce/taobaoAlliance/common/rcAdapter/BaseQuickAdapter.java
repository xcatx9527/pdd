...
import com.Allicnce.taobaoAlliance.common.rcAdapter.animation.*;
import com.Allicnce.taobaoAlliance.common.rcAdapter.entity.IExpandable;
import com.Allicnce.taobaoAlliance.common.rcAdapter.loadmore.LoadMoreView;
import com.Allicnce.taobaoAlliance.common.rcAdapter.loadmore.SimpleLoadMoreView;
import com.Allicnce.taobaoAlliance.common.rcAdapter.util.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
     ...
     * @param data        A newdialog list is created out of this one to avoid mutable list
     */
     ...
     * @param data        A newdialog list is created out of this one to avoid mutable list
     */
    public BaseQuickAdapter(Activity activity, @LayoutRes int layoutResId, @Nullable List<T> data) {
    ...
    /**
     * setting up a newdialog instance to data;
     *
     * @param data
     */
    ...
    /**
     * add one newdialog data in to certain location
     *
     * @param position
     */
    ...
    /**
     * add newdialog data in to certain location
     *
     * @param position
     */
     ...
     * you must override the method to create newdialog ViewHolder.
     *
     * @param view view
     * @return newdialog ViewHolder
     */
