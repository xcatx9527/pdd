package com.Allicnce.taobaoAlliance.common.smartrefresh.impl;
...
import com.Allicnce.taobaoAlliance.PagerAdapterWrapper;
import com.Allicnce.taobaoAlliance.common.smartrefresh.api.RefreshContent;
import com.Allicnce.taobaoAlliance.common.smartrefresh.api.RefreshKernel;
import com.Allicnce.taobaoAlliance.common.smartrefresh.api.RefreshLayout;
import com.Allicnce.taobaoAlliance.common.smartrefresh.api.ScrollBoundaryDecider;
...
import static com.Allicnce.taobaoAlliance.common.smartrefresh.util.ScrollBoundaryUtil.canScrollDown;
import static com.Allicnce.taobaoAlliance.common.smartrefresh.util.ScrollBoundaryUtil.canScrollUp;
    ...
    protected class Api23ViewScrollComponent implements View.OnScrollChangeListener {
        ...
        public void onScrollChange(View v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
            ...
            if (scrollY <= 0 && oldScrollY > 0 && mMotionEvent == null && lastTime - lastTimeOld > 1000 && overScroll && layout.isEnableRefresh()) {
                ...
                } else if (overScroll && lastTime - lastTimeOld > 1000 && !canScrollDown(v)) {
                    final int velocity = (lastOldScrollY - oldScrollY) * 16000 / (int) ((lastTime - lastTimeOld) / 1000f);
