...
class BackgroundCountdown extends BaseCountdown {
    ...
    public void initStyleAttr(Context context, TypedArray ta) {
        ...
        mTimeBgDivisionLineSize = ta.getDimension(R.styleable.CountdownView_timeBgDivisionLineSize, DisplayUtil.dp2px(DEFAULT_TIME_BG_DIVISION_LINE_SIZE));
        mTimeBgSize = ta.getDimension(R.styleable.CountdownView_timeBgSize, 0);
        mDefSetTimeBgSize = mTimeBgSize;
        mTimeBgBorderSize = ta.getDimension(R.styleable.CountdownView_timeBgBorderSize, DisplayUtil.dp2px(DEFAULT_TIME_BG_BORDER_SIZE));
    ...
    protected void initTimeTextBaseInfo() {
        ...
        if (mDefSetTimeBgSize == 0 || mTimeBgSize < mTimeTextWidth) {
            mTimeBgSize = mTimeTextWidth + (DisplayUtil.dp2px(2) * 4);
        }
    }
    ...
    private void initHasBackgroundTextBaseY(RectF rectF) {
        ...
        mTimeBgDivisionLineYPos = rectF.centerY() + (mTimeBgDivisionLineSize == DisplayUtil.dp2px(DEFAULT_TIME_BG_DIVISION_LINE_SIZE) ? mTimeBgDivisionLineSize : mTimeBgDivisionLineSize / 2);
    }
    ...
    public int getAllContentWidth() {
        ...
        if (isShowDay) {
            if (isDayLargeNinetyNine) {
                ...
                mDayTimeBgWidth = rect.width() + (DisplayUtil.dp2px(2) * 4);
    ...
    public void setTimeBgSize(float size) {
        mTimeBgSize = DisplayUtil.dp2px(size);
    }
    ...
    public void setTimeBgRadius(float radius) {
        mTimeBgRadius = DisplayUtil.dp2px(radius);
    }
    ...
    public void setTimeBgDivisionLineSize(float size) {
        mTimeBgDivisionLineSize = DisplayUtil.dp2px(size);
        if (null != mTimeBgDivisionLinePaint) {
            mTimeBgDivisionLinePaint.setStrokeWidth(mTimeBgDivisionLineSize);
        }
    }
    ...
    public void setTimeBgBorderSize(float size) {
        mTimeBgBorderSize = DisplayUtil.dp2px(size);
    ...
    public void setTimeBgBorderRadius(float size) {
        mTimeBgBorderRadius = DisplayUtil.dp2px(size);
    }
