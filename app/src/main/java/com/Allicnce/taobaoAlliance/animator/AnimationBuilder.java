...
public class AnimationBuilder {
    private final ObjectAnimatorUtils viewAnimator;
     ...
     */
    public AnimationBuilder(ObjectAnimatorUtils viewAnimator, View... views) {
    ...
    /**
     * Translation Z animation builder.
     *
     * @param Z the Z
     * @return the animation builder
     */
    public AnimationBuilder translationZ(float... Z) {
        return property("translationZ", Z);
    }
     ...
     * @return the animation builder
     */
    public AnimationBuilder repeatMode(@ObjectAnimatorUtils.RepeatMode int repeatMode) {
     ...
     * @return the animation builder
     */
    public AnimationBuilder onAnimationStart(AnimationListener.Start startListener) {
     ...
     * @return the animation builder
     */
    public AnimationBuilder onAnimationStop(AnimationListener.Stop stopListener) {
    ...
    public ObjectAnimatorUtils accelerate() {
        return viewAnimator.interpolator(new AccelerateInterpolator());
    }

    public ObjectAnimatorUtils decelerate() {
